...
# 	set_property IOSTANDARD LVCMOS33 [get_ports btnU]  W19 es el left T17 es el right
set_property PACKAGE_PIN W19 [get_ports step_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports step_button]
set_property PACKAGE_PIN T17 [get_ports send_button]						
	set_property IOSTANDARD LVCMOS33 [get_ports send_button]
